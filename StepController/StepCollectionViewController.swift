...
//  eSegurado
//
//  Created by Higor Borjaille on 27/04/17.
...
class StepCollectionViewController: UICollectionViewController {
    ...
    override func present(_ viewControllerToPresent: UIViewController, animated flag: Bool, completion: (() -> Void)? = nil) {
        self.wizzard?.present(viewControllerToPresent, animated: flag, completion: completion)
    }
